...
O ATBSPACE permite simular o perfil farmacocinético de antimicrobianos a partir dos dados do paciente, avaliando:

- Curvas de concentração ao longo do tempo (infusão intermitente ou contínua)
- Alvos PK/PD (Css/MIC, T>MIC, AUC/MIC, Pico/MIC)
- Risco de toxicidade
...
> Atualmente, apenas o meropenem está disponível para teste.
